...
"@id": "urn:sbrm:bridge-rollup:frs_105_micro:frc_v2026:profit-loss-on-ordinary-activities-before-tax"
...
bridge_rollup:
  ...
  framework_concept:    "uk-core:ProfitLossOnOrdinaryActivitiesBeforeTax"
  mapping_kind:         "computed_rollup"
  statement_role:       "PL_COMPUTED"
  formula: |
    % PLOnOrdinaryActivitiesBeforeTax = OperatingProfitLoss ± InterestPayableReceivable.
    % FRS 105 Micro: micro template carries no interest line by default; falls through to OperatingProfitLoss.
    'uk-core:ProfitLossOnOrdinaryActivitiesBeforeTax'(P, V) :-
      framework_value(P, 'uk-core:OperatingProfitLoss', V).
  depends_on:
    - "uk-core:OperatingProfitLoss"
  confidence:           "high"
  notes:                "FRS 105 Micro: passes through OperatingProfitLoss; interest line empty by default."

cryptographic_anchor:
  hash_algorithm: "SHA-256"
  hash_target:    "self"
  content_hash:   "8635dbb0b968088d9d66bc4854aa152a36fe388af644d2ba34f79385611ab345"
...
helm_mutations:
  - mutation_id:           "mut-2026-05-13-phase-4a-2"
    ...
    justification:         "Phase 4a.2 promotion of v1 UK_CORE_AGGREGATION_PARENTS entry into Brain canon as computed_rollup: uk-core:ProfitLossOnOrdinaryActivitiesBeforeTax"
...
# Bridge computed-rollup — `uk-core:ProfitLossOnOrdinaryActivitiesBeforeTax` (FRS 105 Micro × FRC v2026)
...
FRS 105 Micro: passes through OperatingProfitLoss; interest line empty by default.
