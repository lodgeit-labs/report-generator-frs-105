...
"@id": "urn:sbrm:bridge-rollup:frs_105_micro:frc_v2026:current-assets"
...
bridge_rollup:
  ...
  formula: |
    % CurrentAssets = Bank + Debtors + Inventories.
    'uk-core:CurrentAssets'(P, V) :-
      framework_value(P, 'uk-core:CashBankOnHand',   Bank),
      framework_value(P, 'uk-core:Debtors',          Deb),
      framework_value(P, 'uk-core:TotalInventories', Inv),
      V is Bank + Deb + Inv.
  depends_on:
    - "uk-core:CashBankOnHand"
    - "uk-core:Debtors"
    - "uk-core:TotalInventories"
  confidence:           "high"
  notes:                "Standard current-assets aggregation. FRS 105 Micro carries these three line items."

cryptographic_anchor:
  hash_algorithm: "SHA-256"
  hash_target:    "self"
  content_hash:   "2d47278935d0c8cd66b814ad8d37a88c094120b4ffbfa70ce872de2781bb6256"
...
helm_mutations:
  - mutation_id:           "mut-2026-05-13-phase-4a-2"
    ...
    justification:         "Phase 4a.2 promotion of v1 UK_CORE_AGGREGATION_PARENTS entry into Brain canon as computed_rollup: uk-core:CurrentAssets"
...
# Bridge computed-rollup — `uk-core:CurrentAssets` (FRS 105 Micro × FRC v2026)
...
Standard current-assets aggregation. FRS 105 Micro carries these three line items.
