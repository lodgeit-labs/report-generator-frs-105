...
"@id": "urn:sbrm:bridge-ancestry:frs_105_micro:frc_v2026:cash_cash_equivalents"
...
bridge_ancestry:
  ancestor_slug:        "cash_cash_equivalents"
  framework_id:         "frs_105_micro"
  taxonomy_version:     "frc_v2026"
  period_applicability: "ongoing"
  framework_concept:    "uk-core:CashBankOnHand"
  mapping_kind:         "ancestry_subsume"
  statement_role:       "BS_ASSET"
  confidence:           "high"
  notes:                '21-node `cash_cash_equivalents` ancestry subsumes to FRC CashBankOnHand. Direct_atom override at sbrm_1137 retained.'
...
cryptographic_anchor:
  ...
  hash_target:    "self"
  content_hash:   "6650ae010e17e9cd1db5fbbfcb0ca0bc8362313ad52d71c8a589257f8ece19e3"
...
helm_mutations:
  - mutation_id:           "mut-2026-05-15-mc07"
    ...
    justification:         "Phase 4a.3 ancestry_subsume — LodgeiT ancestor slug `cash_cash_equivalents` subsumes to FRC v2026 `uk-core:CashBankOnHand`. Anchor verified via Path A v1 lookup at GLOBAL_NOTES/BRIDGE/frs_105_micro/frc_v2026/_path_a_v1_lookup_2026-05-15.md (sidecar: memory/sidecars/BRIDGE-frs_105_micro-frc_v2026-path_a_v1/CashBankOnHand.xsd_excerpt)."
...
# Bridge ancestry_subsume — `cash_cash_equivalents` → `uk-core:CashBankOnHand` (FRS 105 Micro × FRC v2026)

Every SBRM code reachable from the LodgeiT-ontology ancestor slug `cash_cash_equivalents` (via `parent/2` closure in `ClawDog_Share/full_sbrm_physics.pl`) subsumes to FRC v2026 concept `uk-core:CashBankOnHand`, **modulo direct_atom overrides** which always win.

## Notes

21-node `cash_cash_equivalents` ancestry subsumes to FRC CashBankOnHand. Direct_atom override at sbrm_1137 retained.

## Anchor verification

- Framework concept: `uk-core:CashBankOnHand` (local name `CashBankOnHand`)
- Source: `fr/2026-01-01/core/frc-core-2026-01-01.xsd` line `1744`
