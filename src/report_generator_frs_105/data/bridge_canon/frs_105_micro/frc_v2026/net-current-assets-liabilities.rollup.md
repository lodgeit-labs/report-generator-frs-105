...
"@id": "urn:sbrm:bridge-rollup:frs_105_micro:frc_v2026:net-current-assets-liabilities"
...
bridge_rollup:
  ...
  framework_concept:    "uk-core:NetCurrentAssetsLiabilities"
  mapping_kind:         "computed_rollup"
  statement_role:       "BS_COMPUTED"
  formula: |
    % NetCurrentAssetsLiabilities = CurrentAssets - CurrentLiabilities (working capital).
    % CurrentLiabilities = TradeCreditors + BankBorrowings (FRS 105 Micro default).
    'uk-core:NetCurrentAssetsLiabilities'(P, V) :-
      framework_value(P, 'uk-core:CurrentAssets',                 CA),
      framework_value(P, 'uk-core:TradeCreditorsTradePayables',   Trade),
      framework_value(P, 'uk-core:BankBorrowings',                Bank),
      CL is Trade + Bank,
      V is CA - CL.
  depends_on:
    - "uk-core:CurrentAssets"
    - "uk-core:TradeCreditorsTradePayables"
    - "uk-core:BankBorrowings"
  confidence:           "high"
  notes:                "Working capital. FRS 105 Micro CL = TradeCreditors + BankBorrowings only; richer frameworks add more lines."

cryptographic_anchor:
  hash_algorithm: "SHA-256"
  hash_target:    "self"
  content_hash:   "3f3c0fc581e749a0e70c15673f0d7e5eb5f4b8058830e0c1372c321ce7ffc867"
...
helm_mutations:
  - mutation_id:           "mut-2026-05-13-phase-4a-2"
    ...
    justification:         "Phase 4a.2 promotion of v1 UK_CORE_AGGREGATION_PARENTS entry into Brain canon as computed_rollup: uk-core:NetCurrentAssetsLiabilities"
...
# Bridge computed-rollup — `uk-core:NetCurrentAssetsLiabilities` (FRS 105 Micro × FRC v2026)
...
Working capital. FRS 105 Micro CL = TradeCreditors + BankBorrowings only; richer frameworks add more lines.
