...
"@id": "urn:sbrm:bridge-rollup:frs_105_micro:frc_v2026:operating-profit-loss"
...
bridge_rollup:
  ...
  framework_concept:    "uk-core:OperatingProfitLoss"
  mapping_kind:         "computed_rollup"
  statement_role:       "PL_COMPUTED"
  formula: |
    % OperatingProfitLoss = GrossProfitLoss - AdministrativeExpenses ± OtherOperatingItems.
    % FRS 105 Micro: micro template only carries Admin in this position; OtherOperatingItems = 0 by default.
    'uk-core:OperatingProfitLoss'(P, V) :-
      framework_value(P, 'uk-core:GrossProfitLoss',        Gross),
      framework_value(P, 'uk-core:AdministrativeExpenses', Admin),
      V is Gross - Admin.
  depends_on:
    - "uk-core:GrossProfitLoss"
    - "uk-core:AdministrativeExpenses"
  confidence:           "high"
  notes:                "FRS 105 Micro operating profit. Other Operating Items dimension is empty in the micro template."

cryptographic_anchor:
  hash_algorithm: "SHA-256"
  hash_target:    "self"
  content_hash:   "fb62a181206cdcc53ad226f47a83dbc63ce0879dae8195af2862497ff9ac1c5f"
...
helm_mutations:
  - mutation_id:           "mut-2026-05-13-phase-4a-2"
    ...
    justification:         "Phase 4a.2 promotion of v1 UK_CORE_AGGREGATION_PARENTS entry into Brain canon as computed_rollup: uk-core:OperatingProfitLoss"
...
# Bridge computed-rollup — `uk-core:OperatingProfitLoss` (FRS 105 Micro × FRC v2026)
...
FRS 105 Micro operating profit. Other Operating Items dimension is empty in the micro template.
