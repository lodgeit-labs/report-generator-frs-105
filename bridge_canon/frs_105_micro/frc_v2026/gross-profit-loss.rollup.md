...
"@id": "urn:sbrm:bridge-rollup:frs_105_micro:frc_v2026:gross-profit-loss"
...
bridge_rollup:
  ...
  framework_concept:    "uk-core:GrossProfitLoss"
  mapping_kind:         "computed_rollup"
  statement_role:       "PL_COMPUTED"
  formula: |
    % GrossProfitLoss = TurnoverRevenue - CostSales (cost is reported as positive expense; signed-subtraction here).
    'uk-core:GrossProfitLoss'(P, V) :-
      framework_value(P, 'uk-core:TurnoverRevenue', Rev),
      framework_value(P, 'uk-core:CostSales',       Cost),
      V is Rev - Cost.
  depends_on:
    - "uk-core:TurnoverRevenue"
    - "uk-core:CostSales"
  confidence:           "high"
  notes:                "Standard P&L gross-profit. v1 micro_entity_accounts.html template's first computed row."

cryptographic_anchor:
  hash_algorithm: "SHA-256"
  hash_target:    "self"
  content_hash:   "30d38a61a5f95c3d4fc6370e369bba133770f99198fa6ccf79f719bd519d665a"
...
helm_mutations:
  - mutation_id:           "mut-2026-05-13-phase-4a-2"
    ...
    justification:         "Phase 4a.2 promotion of v1 UK_CORE_AGGREGATION_PARENTS entry into Brain canon as computed_rollup: uk-core:GrossProfitLoss"
...
# Bridge computed-rollup — `uk-core:GrossProfitLoss` (FRS 105 Micro × FRC v2026)
...
Standard P&L gross-profit. v1 micro_entity_accounts.html template's first computed row.
