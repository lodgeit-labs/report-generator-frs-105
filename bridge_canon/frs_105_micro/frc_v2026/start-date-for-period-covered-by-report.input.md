...
"@id": "urn:sbrm:bridge-input:frs_105_micro:frc_v2026:start-date-for-period-covered-by-report"
...
bridge_external_input:
  ...
  framework_concept:    "uk-bus:StartDateForPeriodCoveredByReport"
  mapping_kind:         "external_input"
  statement_role:       "BOILERPLATE"
  input_source:         "period_metadata"
  confidence:           "high"
  notes:                "Period start date from the filing's period dimension (Standing Rule #6 Hoffman temporal dimension)."

cryptographic_anchor:
  hash_algorithm: "SHA-256"
  hash_target:    "self"
  content_hash:   "186afcd95850db390814b99dbb13313766d4773714ab7cbd313d4a7257ed7680"
...
helm_mutations:
  - mutation_id:           "mut-2026-05-13-phase-4a-2"
    ...
    justification:         "Phase 4a.2 promotion of v1 UK_CORE_BOILERPLATE entry into Brain canon as external_input: uk-bus:StartDateForPeriodCoveredByReport"
...
# Bridge external-input — `uk-bus:StartDateForPeriodCoveredByReport` (FRS 105 Micro × FRC v2026)
...
Period start date from the filing's period dimension (Standing Rule #6 Hoffman temporal dimension).
